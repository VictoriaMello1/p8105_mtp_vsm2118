...
borough over the five years. Dataset limitations for analyzing
population changes are also addressed.
...
of COVID-19. Although the neighborhoods in these boroughs did see a
recovery from July 2020 onward and remained relatively stable. The Bronx
had a milder COVID-related dip and a significant spike in average net
change in COAs for the Central Bronx and High Bridge/Morrisania
neighborhoods during November, 2021. Queens also had a less severe
COVID-related decline, with the exception of the western neighborhoods
bordering Manhattan.
