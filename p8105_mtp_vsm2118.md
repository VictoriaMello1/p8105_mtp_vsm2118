...
ensuring data quality for analysis. The subsequent section visualizes
the data with an analysis of net address change trends across boroughs
for the 5 year period and addresses limitations of the dataset.
...
borough through manual correction. The resulting tidy dataset contains a
total of 12085 observations. It includes data from 237 zipcodes and data
from 43 neighborhoods.
...
duplicating or misrepresenting zipcode data. “BRONX” and “BROOKLYN” in
the Manhattan table indicate data entry errors or misclassification,
affecting borough-specific analyses. The “city” variable combines
borough and neighborhood info, making it unusable. Instead, for
analysis, use the “neighborhood” variable for micro-neighborhood-level
analysis and the “borough” variable from data cleaning.
...
|   11201 | Northwest Brooklyn            | Brooklyn      | BROOKLYN HEIGHTS    |                 2 |
...
As shown in the table above there are 190 zipcodes with fewer than 60
observations for change of address. There are various potential factors
that are likely contributing to these specific zip codes having less
...
|:--------------|-----:|-------------------:|
| Bronx         | 2018 |         -45.644231 |
| Bronx         | 2019 |         -47.275641 |
| Bronx         | 2020 |         -72.833333 |
| Bronx         | 2021 |         -66.544872 |
| Bronx         | 2022 |         -52.621795 |
| Brooklyn      | 2018 |         -43.189899 |
| Brooklyn      | 2019 |         -51.949495 |
| Brooklyn      | 2020 |        -114.164032 |
| Brooklyn      | 2021 |         -75.712000 |
| Brooklyn      | 2022 |         -54.799595 |
